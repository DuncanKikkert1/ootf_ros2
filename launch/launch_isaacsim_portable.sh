#!/bin/bash
# =============================================================================
# launch_isaacsim_portable.sh — Universal launch script for simulation.py.
# Auto-detects ROS distro, Python, and Isaac Sim paths.
# Run from anywhere: bash launch/launch_isaacsim_portable.sh
#
# If the Isaac Sim ROS workspace is in a non-standard location, set ISAAC_WS:
#   ISAAC_WS=/path/to/workspace bash launch/launch_isaacsim_portable.sh
# =============================================================================
